...
public class PassesThisReferenceToMethodCall {
    ...
    public static final class AsOneOfSeveralParametersWithOtherWeirdCode {
        ...
        public AsOneOfSeveralParametersWithOtherWeirdCode(final boolean param) {
            new GiveMeYourThisReference(staticField, param ? "hi there" : "bye there", getLong(), this, newMap(), 1.0d);
        }
    ...
    public static final class AsParameterToPrivateMethod {
        ...
        private static void dontPublishThisReference(final Object thisReference) {
            final String toString = thisReference.toString();
