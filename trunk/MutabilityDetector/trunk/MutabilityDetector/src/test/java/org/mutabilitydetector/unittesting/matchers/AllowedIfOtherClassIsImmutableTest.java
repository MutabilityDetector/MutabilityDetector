...
public class AllowedIfOtherClassIsImmutableTest {
    ...
    @Test
    public void matchesIfResultIsDefinitelyImmutableAlready() throws Exception {
    ...
    @Test
    public void matchesWhenResultIsNotImmutableOnlyDueToAssigningAbstractTypeToField() throws Exception {
        ...
        AnalysisResult result = analysisResult("possibly.immutable.class", NOT_IMMUTABLE, reason);
        matcher = new AllowedIfOtherClassIsImmutable(dotted("some.mutable.class"));
    ...
    @Test
    public void doesNotMatchWhenThereAreManyAbstractTypesAssignedToFieldAndOnlyOneIsAllowed() {
        CheckerReasonDetail allowed = new CheckerReasonDetail("Field can have an abstract type [some.mutable.class] assigned to it.",
                unusedClassLocation,
                ABSTRACT_TYPE_TO_FIELD);
        CheckerReasonDetail notAllowed = new CheckerReasonDetail("Field can have an abstract type [some.othermutable.class] assigned to it.",
                unusedClassLocation,
                ABSTRACT_TYPE_TO_FIELD);
        AnalysisResult result = analysisResult("possibly.immutable.class", NOT_IMMUTABLE, allowed, notAllowed);
        matcher = new AllowedIfOtherClassIsImmutable(dotted("some.mutable.class"));
