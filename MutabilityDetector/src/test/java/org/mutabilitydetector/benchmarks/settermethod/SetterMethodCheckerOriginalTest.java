...
import org.mutabilitydetector.checkers.SetterMethodCheckerOriginal;
...
public class SetterMethodCheckerOriginalTest {
    
    @Rule public MethodRule rule = new IncorrectAnalysisRule();

    private SetterMethodCheckerOriginal checker;
